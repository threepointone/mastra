                    ...
                    export const RepositoryPipelineVariables: EventHandler<BitbucketIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/repositories/{workspace}/{repo_slug}/pipelines_config/variables'].get({
