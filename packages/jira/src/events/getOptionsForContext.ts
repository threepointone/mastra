                    ...
                    export const getOptionsForContext: EventHandler<JiraIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            const { fieldId,contextId,optionId,onlyOptions,startAt,maxResults, fieldId,contextId,  } = event.data;
