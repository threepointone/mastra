                    ...
                    export const getCreateIssueMetaIssueTypeId: EventHandler<JiraIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            const { projectIdOrKey,issueTypeId,startAt,maxResults, projectIdOrKey,issueTypeId,  } = event.data;
