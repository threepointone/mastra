  ...
  paths: {
    '/appClients': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/appclients:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/appclients:write'],
          },
        ],
      },
    },
    ...
    '/assets': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/assets:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/assets:write'],
          },
        ],
      },
    },
    ...
    '/datasets': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/datasets:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/datasets:write'],
          },
        ],
      },
    },
    ...
    '/deploymentEnvironments': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/secrets:read'],
          },
        ],
      },
      options: {
    ...
    '/deploymentEnvironments/{deploymentEnvironmentId}': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/organizations:read'],
          },
        ],
      },
      options: {
    ...
    '/documents': {
      delete: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/documents:write'],
          },
        ],
      },
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/documents:read'],
          },
        ],
      },
      options: {
    ...
    '/logs': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/logs:read'],
          },
        ],
      },
      options: {
    ...
    '/models': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/models:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/models:write'],
          },
        ],
      },
    },
    ...
    '/models/{modelId}/dataBundles': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/databundles:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/databundles:write'],
          },
        ],
      },
    },
    ...
    '/models/{modelId}/trainings': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/workflows.executions:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/workflows.executions:write'],
          },
        ],
      },
    },
    '/models/{modelId}/trainings/{trainingId}': {
      ...
      patch: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/predictions:write'],
          },
        ],
      },
    },
    '/organizations': {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/organizations:write'],
          },
        ],
      },
    },
    ...
    '/paymentMethods': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/paymentmethods:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/paymentmethods:write'],
          },
        ],
      },
    },
    ...
    '/plans': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/plans:read'],
          },
        ],
      },
      options: {
    ...
    '/predictions': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/predictions:read'],
          },
        ],
      },
      options: {
    ...
    '/secrets': {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/secrets:write'],
          },
        ],
      },
    },
    ...
    '/transitions': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/transitions:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/transitions:write'],
          },
        ],
      },
    },
    ...
    '/transitions/{transitionId}/executions': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/transitions.executions:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/transitions.executions:write'],
          },
        ],
      },
    },
    ...
    '/transitions/{transitionId}/executions/{executionId}/heartbeats': {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/transitions.executions.heartbeats:write'],
          },
        ],
      },
    },
    '/users': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/users:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/users:write'],
          },
        ],
      },
    },
    ...
    '/workflows': {
      get: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/workflows:read'],
          },
        ],
      },
      options: {
      ...
      post: {
        ...
        security: [
          {
            OAuth2: ['api.lucidtech.ai/workflows:write'],
          },
        ],
      },
    },
  ...
  components: {
    schemas: {
      ...
      DataBundles: {
        ...
        required: ['dataBundles', 'nextToken'],
        title: 'dataBundles',
        type: 'object',
      },
      Dataset: {
      ...
      DeploymentEnvironments: {
        ...
        required: ['deploymentEnvironments', 'nextToken'],
      ...
      Log: {
        ...
        required: ['logId', 'startTime', 'transitionExecutionId', 'transitionId', 'workflowExecutionId', 'workflowId'],
        title: 'log',
        type: 'object',
      },
      Logs: {
      ...
      Model: {
        ...
        properties: {
              ...
              oneOf: [
                {
                  properties: {
                    ...
                    type: {
                      enum: ['amount', 'date', 'digits', 'enum', 'numeric', 'string'],
                      type: 'string',
                    },
                  },
                  required: ['type'],
          ...
          preprocessConfig: {
            ...
            required: ['autoRotate', 'imageQuality', 'maxPages'],
            type: 'object',
          },
          status: {
      ...
      Organizations: {
        ...
        required: ['nextToken', 'organizations'],
        title: 'organizations',
        type: 'object',
      },
      PatchAppClientId: {
      ...
      PaymentMethods: {
        ...
        required: ['nextToken', 'paymentMethods'],
      ...
      Plan: {
        ...
        required: ['available', 'currency', 'latest', 'name', 'organizationId', 'planId'],
        title: 'plan',
        type: 'object',
      },
      Plans: {
      ...
      Prediction: {
              ...
              anyOf: [
                {
                  ...
                  required: ['confidence', 'label', 'value'],
                  type: 'object',
                },
                {
                  additionalProperties: false,
        ...
        required: ['documentId', 'inferenceTime', 'modelId', 'predictionId', 'predictions'],
        title: 'prediction',
        type: 'object',
      },
      Predictions: {
        ...
        required: ['nextToken', 'predictions'],
        title: 'predictions',
        type: 'object',
      },
      Profile: {
      ...
      Secret: {
        ...
        required: ['createdBy', 'createdTime', 'description', 'name', 'secretId', 'updatedBy', 'updatedTime'],
        title: 'secret',
        type: 'object',
      },
      Secrets: {
      ...
      Training: {
        ...
        properties: {
          ...
          status: {
            enum: ['waiting-for-approval', 'pending', 'running', 'succeeded', 'failed', 'cancelled'],
            type: 'string',
          },
          trainingId: {
            pattern: '^las:model-training:[a-f0-9]{32}$',
            ...
            items: {
              ...
              properties: {
                ...
                deploymentEnvironmentId: {
                  nullable: true,
                  pattern:
                    '^(|las:organization:[a-z0-9-_]+/)las:deployment-environment:[a-z0-9-_]+(|:@[a-z0-9-_]+|:[0-9]+)$',
                  type: 'string',
                },
                description: {
                  maxLength: 4096,
      ...
      TransitionExecution: {
        ...
        properties: {
          ...
          status: {
            enum: ['running', 'succeeded', 'failed', 'rejected', 'retry'],
            type: 'string',
          },
          transitionId: {
            anyOf: [
        ...
        required: ['completedBy', 'executionId', 'input', 'status', 'transitionId'],
      ...
      TransitionExecutions: {
        ...
        required: ['executions', 'nextToken', 'transitionId'],
      ...
      Transitions: {
        ...
        required: ['nextToken', 'transitions'],
        title: 'transitions',
        type: 'object',
      },
      User: {
        ...
        required: ['createdBy', 'createdTime', 'email', 'updatedBy', 'updatedTime', 'userId'],
        title: 'user',
        type: 'object',
      },
      Users: {
      ...
      WorkflowExecution: {
        ...
        properties: {
          ...
          status: {
            enum: ['running', 'succeeded', 'failed', 'rejected', 'retry', 'error'],
            type: 'string',
          },
          transitionExecutions: {
            nullable: true,
      ...
      WorkflowExecutions: {
        ...
        required: ['executions', 'nextToken', 'workflowId'],
