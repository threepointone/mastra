                    ...
                    export const actions-github-actions-default-workflow-permissions-repository: EventHandler<GithubIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/repos/{owner}/{repo}/actions/permissions/workflow'].get({
                                query: {owner,repo,},
                                params: {owner,repo,} })
