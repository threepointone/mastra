                    ...
                    export const billing_shared_storage_billing_user: EventHandler<GithubIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/users/{username}/settings/billing/shared-storage'].get({
                                query: {username,},
                                params: {username,} })
