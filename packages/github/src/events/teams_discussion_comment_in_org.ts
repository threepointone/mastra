                    ...
                    export const teams_discussion_comment_in_org: EventHandler<GithubIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            const { org,team-slug,discussion-number,comment-number,team_slug,discussion_number,comment_number, } = event.data;
