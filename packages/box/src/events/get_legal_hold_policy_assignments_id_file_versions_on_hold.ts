                    ...
                    export const get_legal_hold_policy_assignments_id_file_versions_on_hold: EventHandler<BoxIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/legal_hold_policy_assignments/{legal_hold_policy_assignment_id}/file_versions_on_hold'].get({
