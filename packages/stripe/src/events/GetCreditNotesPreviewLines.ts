  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v1/credit_notes/preview/lines'].get({
                                query: {amount,credit_amount,ending_before,expand,invoice,limit,lines,memo,metadata,out_of_band_amount,reason,refund,refund_amount,shipping_cost,starting_after,},
                                 })
