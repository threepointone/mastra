                    ...
                    export const GetCustomersCustomerSubscriptionsSubscriptionExposedId: EventHandler<StripeIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v1/customers/{customer}/subscriptions/{subscription_exposed_id}'].get({
