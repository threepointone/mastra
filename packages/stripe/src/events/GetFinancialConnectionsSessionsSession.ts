                    ...
                    export const GetFinancialConnectionsSessionsSession: EventHandler<StripeIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v1/financial_connections/sessions/{session}'].get({
