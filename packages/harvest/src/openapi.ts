export default {
  ...
  components: {
    ...
    schemas: {
      ...
      Tasks: {
        type: 'object',
        required: ['tasks', 'per_page', 'total_pages', 'total_entries', 'next_page', 'previous_page', 'page', 'links'],
        properties: {
          tasks: {
            type: 'array',
            items: {
      ...
      Roles: {
        type: 'object',
        required: ['roles', 'per_page', 'total_pages', 'total_entries', 'next_page', 'previous_page', 'page', 'links'],
        properties: {
          roles: {
            type: 'array',
            items: {
      ...
      Users: {
        type: 'object',
        required: ['users', 'per_page', 'total_pages', 'total_entries', 'next_page', 'previous_page', 'page', 'links'],
        properties: {
          users: {
            type: 'array',
            items: {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            name: 'thank_you',
            description:
              'Set to true to return the subject and body of a thank-you invoice message for the specific invoice.',
            required: false,
            in: 'query',
            schema: {
              type: 'boolean',
          ...
          },
          {
            name: 'reminder',
            description:
              'Set to true to return the subject and body of a reminder invoice message for the specific invoice.',
            required: false,
            in: 'query',
            schema: {
              type: 'boolean',
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  links: {
                    first:
                      'https://api.harvestapp.com/v2/reports/time/clients?from=20170101&page=1&per_page=2000&to=20171231',
                    next: null,
                    previous: null,
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  links: {
                    first:
                      'https://api.harvestapp.com/v2/reports/time/projects?from=20170101&page=1&per_page=2000&to=20171231',
                    next: null,
                    previous: null,
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  links: {
                    first:
                      'https://api.harvestapp.com/v2/reports/time/tasks?from=20170101&page=1&per_page=2000&to=20171231',
                    next: null,
                    previous: null,
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  links: {
                    first:
                      'https://api.harvestapp.com/v2/reports/time/team?from=20170101&page=1&per_page=2000&to=20171231',
                    next: null,
                    previous: null,
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  links: {
                    first:
                      'https://api.harvestapp.com/v2/reports/uninvoiced?from=20170101&page=1&per_page=2000&to=20171231',
                    next: null,
                    previous: null,
                ...
                example: {
                  roles: [
                    ...
                    },
                    {
                      ...
                      user_ids: [2084359, 3122373, 3122374],
                    },
                  ],
                  per_page: 2000,
                  total_pages: 1,
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  user_ids: [3122374, 3122373, 2084359],
                },
              },
            },
          },
            ...
            content: {
              'application/json': {
                ...
                example: {
                  ...
                  cost_rate: 0,
                  roles: [],
                  access_roles: ['manager', 'project_creator', 'time_and_expenses_manager'],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            name: 'page',
            description:
              'DEPRECATED The page number to use in pagination. For instance, if you make a list request and receive 100 records, your subsequent call can include page=2 to retrieve the next page of the list. (Default: 1)',
            required: false,
            in: 'query',
            schema: {
              type: 'integer',
