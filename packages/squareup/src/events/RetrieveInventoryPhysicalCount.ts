                    ...
                    export const RetrieveInventoryPhysicalCount: EventHandler<SquareupIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v2/inventory/physical-counts/{physical_count_id}'].get({
