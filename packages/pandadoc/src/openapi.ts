  ...
  "paths": {
    ...
    "/public/v1/documents/{id}/recipients/{recipient_id}": {
      "patch": {
        "summary": "Edit Document Recipient",
    ...
    "/public/v1/documents/{id}/recipients/{recipient_id}/reassign": {
      "post": {
        "summary": "Reassign Document Recipient",
    ...
    "/public/v1/webhook-subscriptions/{id}/shared-key": {
      "patch": {
        ...
        "summary": "Regenerate webhook subscription shared key",
    ...
    "/public/v1/webhook-events": {
      "get": {
        ...
        "summary": "Get webhook event page",
        ...
        "parameters": [
          ...
          },
          {
            "name": "since",
            "in": "query",
            "description": "Filter option: all events from specified timestamp",
            "required": false,
            "schema": {
              "type": "string",
              "format": "date-time"
          ...
          },
          {
            "name": "to",
            "in": "query",
            "description": "Filter option: all events up to specified timestamp",
            "required": false,
            "schema": {
              "type": "string",
              "format": "date-time"
          ...
          },
          {
            "name": "type",
            "in": "query",
            "description": "Filter option: all events of type",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            ...
            "in": "query",
            "description": "Filter option: all events of http status code",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "error",
            "in": "query",
            "description": "Filter option: all events with following error",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
    ...
    "/public/v1/webhook-events/{id}": {
      "get": {
        ...
        "summary": "Get webhook event by uuid",
    ...
    "schemas": {
      ...
      "DocumentCreateRequest": {
        ...
        "properties": {
          ...
          "owner": {
            "type": "object",
            "description": "You can set an owner of a document as an `email` or `membership_id`",
      ...
      "DocumentUpdateRequest": {
        ...
        "properties": {
          ...
          "tokens": {
            "type": "array",
            "description": "You can pass a list of tokens/values. If a token name exists in a document then the value will be updated. Otherwise, a new token will be added to the document.",
            "items": {
              "type": "object",
              "properties": {
                "name": {
          ...
          "forwarding_settings": {
            ...
            "properties": {
              ...
              "forwarding_with_reassigning_allowed": {
                "type": "boolean",
                "description": "Allow forwarding with reassigning",
                "example": true
              }
            }
          },
      ...
      "WebhookSubscriptionItemResponse": {
        ...
        "properties": {
          "uuid": {
            ...
            "format": "uuid",
            "nullable": true,
            "example": "c661e488-619e-8001-821febbd3b93"
          },
          "name": {
            "type": "string",
            "nullable": false,
