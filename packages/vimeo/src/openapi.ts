      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'date', 'followers', 'relevant', 'videos'],
              type: 'string',
            },
          },
        ],
          ...
          content: {
            'application/vnd.vimeo.credit+json': {
              schema: {
                ...
                required: ['email', 'name', 'role', 'user_uri'],
                type: 'object',
              },
            },
          },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'comments', 'date', 'duration', 'likes', 'plays'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'date', 'duration', 'videos'],
              type: 'string',
            },
          },
        ],
      ...
      post: {
              ...
              schema: {
                properties: {
                  ...
                  privacy: {
                    ...
                    enum: ['anybody', 'embed_only', 'password'],
                    type: 'string',
                  },
                  review_mode: {
        ...
        responses: {
          ...
          '403': {
            ...
            description:
              "The supplied token doesn't have the proper scopes, or the authenticated user can't create an album.",
          },
        },
        security: [
          {
      ...
      patch: {
        ...
        responses: {
          ...
          '403': {
            ...
            description:
              "The authenticated user doesn't own the album, the supplied token doesn't have the proper scopes, or the authenticated user can't edit the album.",
          },
          '404': {
            content: {
              'application/vnd.vimeo.album+json': {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['added', 'alphabetical', 'date', 'name', 'purchase_time', 'rating', 'release_date'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'comments', 'date', 'default', 'likes', 'manual', 'plays'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['date', 'default', 'modified_time', 'name'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'date', 'default', 'duration', 'last_user_action_event_date'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['app_only', 'embeddable', 'featured', 'playable'],
              type: 'string',
            },
          },
          {
                  ...
                  spatial: {
                    properties: {
                      ...
                      projection: {
                        ...
                        enum: ['cubical', 'cylindrical', 'dome', 'equirectangular', 'pyramid'],
                        type: 'string',
                      },
                      stereo_format: {
                        description: 'The 360 spatial stereo format.',
                        enum: ['left-right', 'mono', 'top-bottom'],
                        type: 'string',
                      },
                    },
                    type: 'object',
          ...
          content: {
            'application/vnd.vimeo.auth+json': {
              schema: {
                ...
                required: ['grant_type', 'token', 'token_secret'],
                type: 'object',
              },
            },
          },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'date', 'name', 'publish.time', 'videos'],
              type: 'string',
            },
          },
        ],
              ...
              schema: {
                properties: {
                  ...
                  product_type: {
                    ...
                    enum: ['any', 'buy', 'buy_episode', 'rent', 'rent_episode', 'subscribe'],
                    type: 'string',
                  },
                  start_time: {
                    description:
                  ...
                  stream_period: {
                    ...
                    enum: ['1_week', '1_year', '24_hour', '30_day', '3_month', '48_hour', '6_month', '72_hour'],
                    type: 'string',
                  },
                  total: {
                    description:
                ...
                required: ['download', 'stream_period', 'total', 'type'],
                type: 'object',
              },
            },
          },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['date', 'default', 'manual', 'name', 'purchase_time', 'release_date'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['created_time', 'duration', 'name'],
              type: 'string',
            },
          },
        ],
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['alphabetical', 'comments', 'date', 'duration', 'likes', 'plays', 'relevant'],
              type: 'string',
            },
          },
          {
  ...
  components: {
    schemas: {
          ...
          metadata: {
            ...
            properties: {
              ...
              interactions: {
                ...
                required: ['add_custom_thumbnails', 'add_logos', 'add_videos'],
                type: 'object',
              },
            },
          ...
          metadata: {
            ...
            properties: {
              connections: {
                ...
                required: ['privacy_users', 'users', 'videos'],
                type: 'object',
              },
              interactions: {
                ...
                properties: {
                  ...
                  follow: {
                    ...
                    required: ['added', 'added_time', 'type', 'uri'],
                    type: 'object',
                  },
                  moderate_videos: {
                    description:
                ...
                required: ['add_moderators', 'add_to', 'follow', 'moderate_videos'],
                type: 'object',
              },
            },
            required: ['connections', 'interactions'],
      ...
      comment: {
        ...
        required: ['created_on', 'metadata', 'resource_key', 'text', 'type', 'uri', 'user'],
        title: 'Comment',
        type: 'object',
      },
      'content-rating': {
      ...
      'embed-settings': {
        properties: {
          buttons: {
            ...
            required: ['embed', 'fullscreen', 'hd', 'like', 'scaling', 'share', 'watchlater'],
            type: 'object',
          },
          color: {
        ...
        required: ['buttons', 'color', 'logos', 'playbar', 'speed', 'title', 'volume'],
      ...
      error: {
        ...
        required: ['developer_message', 'error', 'error_code', 'link'],
        title: 'Error',
        type: 'object',
      },
      group: {
        properties: {
              ...
              interactions: {
                ...
                properties: {
                  join: {
                    ...
                    required: ['added', 'added_time', 'title', 'type', 'uri'],
                    type: 'object',
                  },
                },
                required: ['join'],
          ...
          privacy: {
            ...
            required: ['comment', 'invite', 'join', 'videos', 'view'],
            type: 'object',
          },
          resource_key: {
      ...
      'on-demand-genre': {
        ...
        required: ['canonical', 'interactions', 'link', 'metadata', 'name', 'uri'],
      ...
      'on-demand-page': {
        properties: {
                      ...
                      connections: {
                        properties: {
                          ...
                          videos: {
                            ...
                            required: ['extra_total', 'main_total', 'options', 'total', 'uri', 'viewable_total'],
                            type: 'object',
                          },
                        },
                        required: ['comments', 'genres', 'likes', 'pictures', 'seasons', 'videos'],
                        type: 'object',
                      },
                    },
                    required: ['connections'],
          ...
          preorder: {
            ...
            required: ['active', 'cancel_time', 'publish_time', 'time'],
            type: 'object',
          },
          published: {
            properties: {
      ...
      'on-demand-promotion': {
        properties: {
          ...
          stream_period: {
            ...
            enum: ['1_week', '1_year', '24_hour', '30_days', '3_month', '48_hour', '6_month', '72_hour'],
            example: '1_week',
            nullable: true,
            type: 'string',
          },
          ...
          type: {
            ...
            enum: ['batch', 'batch_prefix', 'single'],
            example: 'batch',
            type: 'string',
          },
          uri: {
      ...
      'on-demand-promotion-code': {
        ...
        required: ['code', 'link', 'max_uses', 'uses'],
      ...
      'on-demand-region': {
        ...
        required: ['country_code', 'country_name', 'uri'],
      ...
      'on-demand-season': {
        ...
        required: ['description', 'metadata', 'name', 'position', 'resource_key', 'type', 'uri', 'user'],
      ...
      'on-demand-video': {
        ...
        required: ['buy', 'interactions', 'link', 'metadata', 'play_progress', 'release_year', 'rent', 'type', 'uri'],
      ...
      picture: {
        ...
        required: ['active', 'resource_key', 'sizes', 'type', 'uri'],
        title: 'Picture',
        type: 'object',
      },
      play: {
        properties: {
            ...
            items: {
              properties: {
                ...
                type: {
                  ...
                  enum: ['source', 'video/mp4', 'video/webm', 'vp6/x-video'],
                  example: 'source',
                  nullable: true,
                  type: 'string',
                },
          ...
          status: {
            ...
            enum: ['playable', 'purchase_required', 'restricted', 'unavailable'],
            example: 'playable',
            type: 'string',
          },
        },
      ...
      portfolio: {
        properties: {
          ...
          sort: {
            ...
            enum: ['alphabetical', 'clips', 'modified', 'recent'],
        ...
        required: ['created_time', 'description', 'link', 'metadata', 'modified_time', 'name', 'sort', 'uri'],
        title: 'Portfolio',
        type: 'object',
      },
      presets: {
          ...
          settings: {
            ...
            properties: {
              buttons: {
                ...
                required: ['embed', 'hd', 'like', 'share', 'vote', 'watchlater'],
                type: 'object',
              },
              logos: {
                properties: {
                ...
                required: ['custom', 'sticky_custom', 'vimeo'],
                type: 'object',
              },
              outro: {
                properties: {
                  ...
                  type: {
                    ...
                    enum: ['link', 'no idea', 'text', 'uploaded_clips', 'uploaded_videos'],
                    example: 'link',
                    type: 'string',
                  },
                  videos: {
        ...
        required: ['metadata', 'name', 'settings', 'uri', 'user'],
        title: 'Presets',
        type: 'object',
      },
      project: {
        ...
        required: ['created_time', 'metadata', 'modified_time', 'name', 'resource_key', 'uri', 'user'],
        title: 'Project',
        type: 'object',
      },
          ...
          subscribe: {
            ...
            properties: {
              ...
              stream: {
                ...
                enum: ['available', 'purchased', 'restricted', 'unavailable'],
                example: 'available',
                type: 'string',
              },
              uri: {
      ...
      tag: {
        ...
        required: ['canonical', 'metadata', 'name', 'resource_key', 'uri'],
        title: 'Tag',
        type: 'object',
      },
      'text-track': {
      ...
      'upload-attempt': {
        ...
        required: ['ticket_id', 'upload_link', 'uri', 'user'],
              ...
              interactions: {
                properties: {
                  ...
                  block: {
                    ...
                    required: ['added', 'added_time', 'options', 'uri'],
                    type: 'object',
                  },
                  follow: {
                  ...
                  report: {
                    ...
                    required: ['options', 'reason', 'uri'],
                    type: 'object',
                  },
                },
                required: ['block', 'follow', 'report'],
                type: 'object',
              },
            },
            required: ['connections', 'interactions'],
          ...
          upload_quota: {
            ...
            properties: {
              ...
              periodic: {
                ...
                required: ['free', 'max', 'reset_date', 'used'],
                type: 'object',
              },
              space: {
                ...
                required: ['free', 'max', 'showing', 'used'],
                type: 'object',
              },
            },
            required: ['lifetime', 'periodic', 'space'],
            type: 'object',
          },
          uri: {
      ...
      video: {
        properties: {
          ...
          context: {
            ...
            properties: {
              action: {
                ...
                enum: ['Added to', 'Appearance by', 'Liked by', 'Uploaded by'],
                example: 'Added to',
                type: 'string',
              },
              resource: {
            ...
            required: ['action', 'resource', 'resource_type'],
            type: 'object',
          },
          created_time: {
          ...
          metadata: {
            ...
            properties: {
              connections: {
                ...
                properties: {
                  ...
                  ondemand: {
                    ...
                    required: ['options', 'resource_key', 'uri'],
                    type: 'object',
                  },
                  pictures: {
              ...
              interactions: {
                ...
                required: ['buy', 'channel', 'like', 'rent', 'report', 'watched', 'watchlater'],
                type: 'object',
              },
            },
            required: ['connections', 'interactions'],
          ...
          privacy: {
            ...
            required: ['add', 'comments', 'download', 'embed', 'view'],
            type: 'object',
          },
          release_time: {
          ...
          spatial: {
            ...
            required: ['director_timeline', 'field_of_view', 'projection', 'stereo_format'],
            type: 'object',
          },
          stats: {
        ...
        flows: {
          authorizationCode: {
            ...
            scopes: {
              ...
              interact:
                "Interact with Vimeo resources on a member's behalf, such as liking a video or following another member",
