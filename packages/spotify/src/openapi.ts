  ...
  paths: {
    ...
    '/chapters': {
      get: {
        ...
        tags: ['Chapters'],
        'x-spotify-docs-console-url':
          '/console/get-several-chapters/?ids=2i47HuOBSV2XaJNy0NCZXM,2GUbORsUnP1qVVlLwd9DzP',
    ...
    '/episodes': {
      get: {
        ...
        tags: ['Episodes'],
        'x-spotify-docs-console-url':
          '/console/get-several-episodes/?ids=77o6BIVlYM3msb4MMIL1jH,0Q86acNRm6V9GYx55SXKwf',
