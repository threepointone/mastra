export default {
  ...
  'x-tag-groups': [
    ...
    },
    {
      name: 'Routing',
      popular: true,
      tags: ['Agent Status', 'Channels', 'Folders', 'Presence Status', 'Tasks', 'Topologies'],
    },
  ],
  tags: [
    {
  ...
  paths: {
    ...
    '/bots/handover': {
      post: {
        description:
          'This method is used to handover a conversation between a bot and an agent. It handles 2 different cases, specific sources handover (Messenger for example, see Bots API doc) and handover between Virtual Agents and human agents. This method recategorizes the thread if the thread_category_ids parameter is provided.',
        ...
        parameters: [
          ...
          {
            description:
              'The foreign_id of the identity for which you want to do the handover (only for source specific handover).',
            in: 'query',
    ...
    '/channels/{channelId}': {
      ...
      put: {
        ...
        parameters: [
          ...
          {
            description:
              'Number of tasks that can be assigned to agent by the routing before they are considered "occupied".',
            in: 'query',
      ...
      put: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['ignored_categories', 'selected_categories'],
              type: 'string',
            },
          },
          {
          ...
          {
            description:
              'Only on Engage Messaging sources that are not on livechat mode. Enable or disable the source on Android.',
            in: 'query',
            name: 'enable_android',
            required: false,
            schema: {
          ...
          {
            description:
              'Only on Engage Messaging sources that are not on livechat mode. Enable or disable the source on iOS.',
            in: 'query',
            name: 'enable_ios',
            required: false,
            schema: {
          ...
          {
            description:
              'Only on Engage Messaging sources that are not on livechat mode. Enable or disable the source on the web.',
            in: 'query',
            name: 'enable_web',
            required: false,
            schema: {
          ...
          {
            description:
              'IMAP OAuth 2.0 refresh token. Used when IMAP authentication type is `microsoft_identity_platform`. Only on Email sources',
            in: 'query',
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['basic', 'microsoft_identity_platform'],
              type: 'string',
            },
          },
          {
            ...
            required: false,
            schema: {
              enum: ['NONE', 'PEER', 'CLIENT_ONCE', 'FAIL_IF_NO_PEER_CERT'],
              type: 'string',
            },
          },
          {
          ...
          {
            description:
              'SMTP OAuth 2.0 refresh token. Used when SMTP authentication type is `microsoft_identity_platform`. Only on Email sources',
            in: 'query',
    ...
    '/content_threads': {
      get: {
        ...
        parameters: [
          {
            description:
              'A search query to filter threads. Please refer to ​Search & filtering parameters​ for more details.',
            in: 'query',
            name: 'q',
            required: false,
            schema: {
    ...
    '/contents': {
      ...
      post: {
        ...
        parameters: [
          {
            description:
              'The identity id of content. This parameter is not mandatory, by default it use the token’s user first identity on source.',
            in: 'query',
            name: 'author_id',
            required: false,
            schema: {
          ...
          {
            description:
              'The content’s id you want to reply to. If omitted, a new discussion will be created. If source does not support to initiate discussion this parameter is mandatory.',
            in: 'query',
            name: 'in_reply_to_id',
            required: false,
            schema: {
          ...
          {
            description:
              'Created contents are public by default, set this parameter to "true" in order to create a private reply. It is NOT supported on every source.',
            in: 'query',
            name: 'private',
            required: false,
            schema: {
          ...
          {
            description:
              'The source to create content to. If you specify `in_reply_to_id` parameter, source will be determined from it. Otherwise, this parameter is mandatory.',
            in: 'query',
            name: 'source_id',
            required: false,
            schema: {
          ...
          {
            description:
              'For an email source. The subject of the email. This parameter is mandatory when initiating a discussion.',
            in: 'query',
            name: 'title',
            required: false,
            schema: {
          ...
          {
            description:
              'For an email source. An array containing the email addresses used in the “To” section of the email. This parameter is mandatory when initiating a discussion.',
            explode: true,
            in: 'query',
            name: 'to[]',
            required: false,
          ...
          {
            description:
              'For an email source. An array containing the email addresses used in the “Cc” section of the email.',
            explode: true,
            in: 'query',
            name: 'cc[]',
            required: false,
          ...
          {
            description:
              'For an email source. An array containing the email addresses used in the “Bcc” section of the email.',
            explode: true,
            in: 'query',
            name: 'bcc[]',
            required: false,
          ...
          {
            description:
              'Mandatory for a WhatsApp source. A discussion can only be initiated using a specific template created on the business manager and approved by WhatsApp. You can find all available template_names on /1.0/content_sources/source_id.',
            explode: true,
            in: 'query',
            name: 'template_name',
            required: false,
          ...
          {
            description:
              'Mandatory for a WhatsApp source. A discussion can only be initiated using a specific template created on the business manager and approved by WhatsApp. You can find all available template_languages for a given template_name on /1.0/content_sources/source_id.',
            explode: true,
            in: 'query',
    ...
    '/custom_fields': {
      ...
      post: {
        ...
        parameters: [
          ...
          {
            description:
              'The key of the custom field (example: customer_id). This is used to determine how it is stored on identity groups.',
            in: 'query',
            name: 'key',
            required: false,
            schema: {
          ...
          {
            description:
              'The type of the custom field. It can be string, boolean, text, integer, float, single_choice,',
            in: 'query',
            name: 'type',
            required: false,
            schema: {
              enum: ['string', 'boolean', 'text', 'integer', 'float', 'single_choice', 'multiple_choice'],
              type: 'string',
            },
          },
          {
    ...
    '/folders': {
      get: {
        description:
          'This method renders folders (shared folders and search folders that belongs to the current user).',
      ...
      post: {
        ...
        parameters: [
          ...
          {
            description:
              'query of the folder as described in ​Search API documentation.​\\n\\nExample: “​active_and_assigned_to_me:true”',
            in: 'query',
            name: 'query',
            required: false,
            schema: {
          ...
          {
            description:
              'list of roles allowed to see this folder. This parameter has to be a hash otherwise it will raise a 400 error. The key should be "only". For example: `&role_restriction[only][]=4e5596cdae70f677b5000002`',
            in: 'query',
          ...
          {
            description:
              'list of teams allowed to see this folder. Same thing as role_restriction: team_restriction parameter has to be a hash with the key "only".',
            in: 'query',
    ...
    '/identities/import': {
      post: {
        ...
        parameters: [
          ...
          {
            description:
              'The identifier representing the identity on the community (email address for emails communities, phone number with international format for phone communities).',
            in: 'query',
            name: 'identifier',
            required: true,
            schema: {
          ...
          {
            description:
              "If present and an identity with the provided identifier is already existing, it'll be updated. Otherwise, the following parameters will be used only during an identity creation.",
            in: 'query',
            name: 'upsert',
            required: false,
            schema: {
    ...
    '/identity_groups': {
      get: {
        ...
        parameters: [
          ...
          {
            description:
              'To change the criteria chosen to sort the identities. The value can be “created_at” or “updated_at”.',
            in: 'query',
            name: 'sort',
            required: false,
            schema: {
    ...
    '/identity_groups/{identityGroupId}/merge': {
      put: {
        description:
          'This method merges an identity into an identity group. In case of conflicts, the attributes of the identity group will be kept. The identity group will be returned.\nAuthorization​: only users which can update identities.',
    ...
    '/interventions': {
      get: {
        ...
        parameters: [
          ...
          {
            description:
              'To filter interventions on given identity_group_id. This will return interventions associated to any identity in the identity_group.',
            in: 'query',
            name: 'identity_group_id',
            required: false,
            schema: {
          ...
          {
            description:
              'To filter interventions on given identity_id(s). Can be a single value or an array of string.',
            explode: true,
            in: 'query',
            name: 'identity_id',
            required: false,
          ...
          },
          {
            ...
            required: false,
            schema: {
              enum: ['active', 'closed', 'deferred', 'opened', 'reopened'],
            },
          },
          {
            description:
              'To change the criteria chosen to sort the interventions. The value can be “created_at” or “updated_at”.',
            in: 'query',
            name: 'sort',
            required: false,
            schema: {
    ...
    '/interventions/{interventionId}': {
      ...
      put: {
        ...
        parameters: [
          ...
          {
            description:
              'Intervention custom field with key "custom_field_key". It can be multiple if custom field is multiple or is has multiple_choice type.',
            in: 'query',
            name: 'custom_field_values[custom_field_key]',
            required: false,
            schema: {
    ...
    '/reply_assistant/entries/{replyAssistantEntryId}': {
      ...
      put: {
        ...
        parameters: [
          ...
          {
            description:
              'The internal/company id of the entry. This is used to match Engage Digital entry’s id with the company one. Example: KB042.',
            in: 'query',
            name: 'foreign_id',
            required: false,
            schema: {
          ...
          {
            description:
              'To restrict the entry to a set of Engage Digital categories. Then, KB entries that do not match message’s categories to which you are replying will not be suggested.',
            explode: true,
            in: 'query',
            name: 'category_ids[]',
            required: false,
    ...
    '/tasks': {
      get: {
        ...
        parameters: [
          {
            description:
              'To filter tasks on given queue name (filters on the “global” queue by default).The most commonly used queues are: “global” (contains every task pending assignation), “workbin_{agent_id}” (contains every tasks assigned to the {agent_id} agent, “history” (contains every processed tasks), and “undelivered” (contains every undelivered tasks). If queue is set to “workbins” all the tasks currently in a workbin will be returned.',
            in: 'query',
            name: 'queue',
            required: false,
            schema: {
    ...
    '/time_sheets': {
      ...
      post: {
        ...
        parameters: [
          ...
          {
            description:
              'A string containing the first two letters of your country (example: "fr"/"en"/"es"), useful to bootstrap default holidays following to a country.',
            in: 'query',
            name: 'holidays_region',
            required: false,
            schema: {
              enum: ['de', 'es', 'fr', 'gb', 'it', 'nl', 'us'],
              type: 'string',
            },
          },
          {
            description:
              'An array containing one or more hash of holidays, a holiday must contain a name (string) and a date (string), the date must be in a valid format, a valid format is a format corresponding to your domain’s locale).',
            in: 'query',
            name: 'holidays',
            required: false,
            schema: {
          ...
          {
            description:
              'this field define the time intervals of the day (in secs). An empty string means that there are no business hours on this day. See `monday_hours` for the format.',
            in: 'query',
            name: 'tuesday_hours',
            required: false,
            schema: {
    ...
    '/users': {
      ...
      post: {
        ...
        parameters: [
          ...
          {
            description:
              'Use the timezone endpoint to get the timezone name (String), default is empty for domain timezone.',
            in: 'query',
            name: 'timezone',
            required: false,
            schema: {
          ...
          {
            description:
              'List of locales corresponding to the languages spoken by the user (multiple). Is not available with RingCX.',
            in: 'query',
            name: 'spoken_languages[]',
            required: false,
            schema: {
          ...
          {
            description:
              'Whether the user is passwordless or not (boolean). Must be used with the corresponding SSO configuration.',
            in: 'query',
            name: 'no_password',
            required: false,
            schema: {
    ...
    '/users/{userId}/sources_permissions': {
      get: {
        ...
        tags: ['Users Sources Permissions'],
      },
      put: {
        description:
          'This method updates the permissions the user has on each source.\nAuthorization​: only users that can view users. If the user affiliated to the token has the manage_users_of_my_teams permission, only the signatures of the users belonging to at least one of the teams he’s the leader of will be available.',
    ...
    '/users/{userId}/signatures': {
      ...
      post: {
        ...
        parameters: [
          ...
          {
            description:
              'The signature list of source ids (multiple). Keep it empty if you don’t need to associate the signature with any sources.',
            in: 'query',
            name: 'source_ids[]',
            required: false,
            schema: {
