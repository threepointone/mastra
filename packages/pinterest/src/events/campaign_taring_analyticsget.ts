                    ...
                    export const campaign_taring_analyticsget: EventHandler<PinterestIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/ad_accounts/{ad_account_id}/campaigns/targeting_analytics'].get({
                                query: {path_ad_account_id,query_campaign_ids_required,query_start_date,query_end_date,query_campaign_targeting_types,query_columns,query_granularity,query_conversion_attribution_click_window_days,query_conversion_attribution_engagement_window_days,query_conversion_attribution_view_window_days,query_conversion_attribution_conversion_report_time,query_attribution_types,},
