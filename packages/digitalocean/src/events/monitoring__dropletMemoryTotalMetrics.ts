                    ...
                    export const monitoring__dropletMemoryTotalMetrics: EventHandler<DigitaloceanIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v2/monitoring/metrics/droplet/memory_total'].get({
