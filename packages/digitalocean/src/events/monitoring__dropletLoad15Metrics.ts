                    ...
                    export const monitoring__dropletLoad15Metrics: EventHandler<DigitaloceanIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v2/monitoring/metrics/droplet/load_15'].get({
