                    ...
                    import { #/paths/~1v2~1monitoring~1metrics~1droplet~1filesystem_free/get/responses/200Fields } from '../constants';
                    import { DigitaloceanIntegration } from '..';

                    export const monitoring__dropletFilesystemSizeMetrics: EventHandler<DigitaloceanIntegration> = ({
  eventKey,
  ...
  makeWebhookUrl,
                        ...
                        executor: async ({ event, step }: any) => {
                            ...
                            const response = await proxy['/v2/monitoring/metrics/droplet/filesystem_size'].get({
                            ...
                            const records = d?.data?.map(({ _externalId, ...d2 }) => ({
                                ...
                                data: d2,
                                entityType: `#/paths/~1v2~1monitoring~1metrics~1droplet~1filesystem_free/get/responses/200`,
                            }));
                            ...
                            await dataLayer?.syncData({
                                ...
                                referenceId,
                                data: records,
                                type: `#/paths/~1v2~1monitoring~1metrics~1droplet~1filesystem_free/get/responses/200`,
                                properties: #/paths/~1v2~1monitoring~1metrics~1droplet~1filesystem_free/get/responses/200Fields,
                            });
                        },
                })
