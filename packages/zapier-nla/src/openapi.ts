export default {
  ...
  info: {
    ...
    'x-logo': {
      url: 'https://cdn.zappy.app/510654b671e2f1ac493e282bc11882ee.png',
    },
    'x-origin': [
      {
        format: 'openapi',
        ...
        parameters: [
          {
            ...
            schema: {
              ...
              type: 'string',
              'x-examples': ['01ARZ3NDEKTSV4RRFFQ69G5FAV'],
            },
          },
        ],
        responses: {
  ...
  components: {
    schemas: {
      ...
      ExecuteResponse: {
        ...
        required: ['id', 'action_used', 'input_params', 'review_url', 'additional_results'],
