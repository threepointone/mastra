  ...
  paths: {
    ...
    '/2/users/{id}/blocking': {
      ...
      post: {
        ...
        security: [
          {
            OAuth2UserToken: ['block.write', 'tweet.read', 'users.read'],
          },
          {
            UserToken: [],
          },
        ...
        flows: {
          authorizationCode: {
            ...
            scopes: {
              ...
              'users.read':
                'Any account you can see, including protected accounts. Any account you can see, including protected accounts.',
            },
